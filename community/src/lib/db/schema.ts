...
export const cachedReposRelations = relations(cachedRepos, ({ one }) => ({
  instance: one(instances, {
    fields: [cachedRepos.instanceId],
    references: [instances.id],
  }),
}));

export const cachedUsersRelations = relations(cachedUsers, ({ one }) => ({
  instance: one(instances, {
    fields: [cachedUsers.instanceId],
    references: [instances.id],
  }),
}));
