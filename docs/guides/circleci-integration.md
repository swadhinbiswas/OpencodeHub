# Using CircleCI with OpenCodeHub
...
If you use OpenCodeHub's [merge queue](../features/merge-queue.md), it automatically respects CircleCI status:
...
- [Set up Merge Queue](../features/merge-queue.md)
- [Configure Branch Protection](../guides/branch-protection.md)
- [Add more external CI providers](external-ci.md) (GitLab CI, Jenkins, Buildkite)
