# OpenCodeHub Worker on CircleCI
...
- [CircleCI Integration Guide](../guides/circleci-integration.md) — For CI/CD pipelines
- [Deployment Guide](../administration/deployment.md) — Production setup
- [Merge Queue](../features/merge-queue.md) — How merge queue works
