...
```bash
# Fork and clone
git clone https://github.com/YOUR-USERNAME/OpenCodeHub.git
cd OpenCodeHub
...
<p align="center">
  ...
  <br>
  <a href="https://github.com/yourusername/OpenCodeHub/issues">Report Bug</a> •
  <a href="https://github.com/yourusername/OpenCodeHub/issues">Request Feature</a>
</p>
