...
export const repositories = pgTable(
  ...
  (t) => ({
    ownerNameIdx: uniqueIndex("repositories_owner_name_idx").on(
      t.ownerId,
      t.name,
    ),
    ownerSlugIdx: uniqueIndex("repositories_owner_slug_idx").on(
      t.ownerId,
      t.slug,
    ),
    ownerIdx: index("repositories_owner_idx").on(t.ownerId),
  }),
);
...
export const branches = pgTable(
  ...
  (t) => ({
    repoNameIdx: uniqueIndex("branches_repo_name_idx").on(
      t.repositoryId,
      t.name,
    ),
  }),
...
export const commits = pgTable(
  ...
  (t) => ({
    repoShaIdx: uniqueIndex("commits_repo_sha_idx").on(t.repositoryId, t.sha),
...
export const tags = pgTable(
  ...
  (t) => ({
    repoNameIdx: uniqueIndex("tags_repo_name_idx").on(t.repositoryId, t.name),
  }),
);
...
export const repositoryStars = pgTable(
  ...
  (t) => ({
    starRepoUserIdx: uniqueIndex("stars_repo_user_idx").on(
      t.repositoryId,
      t.userId,
    ),
  }),
...
export const repositoryWatchers = pgTable(
  "repository_watchers",
  {
    id: text("id").primaryKey(),
    repositoryId: text("repository_id")
  ...
  (t) => ({
    watcherRepoUserIdx: uniqueIndex("watchers_repo_user_idx").on(
      t.repositoryId,
      t.userId,
    ),
  }),
...
export const repositoryCollaborators = pgTable(
  ...
  (t) => ({
    collabRepoUserIdx: uniqueIndex("collaborators_repo_user_idx").on(
      t.repositoryId,
      t.userId,
    ),
  }),
...
export const repositoryStarsRelations = relations(
  repositoryStars,
  ({ one }) => ({
    repository: one(repositories, {
