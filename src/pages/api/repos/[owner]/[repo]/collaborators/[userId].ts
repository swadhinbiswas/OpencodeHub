...
export const PATCH: APIRoute = withErrorHandler(async ({ params, request }) => {
    ...
    logger.info({ userId: tokenPayload.userId, repoId: repository.id, collaboratorId: userId, role }, "Collaborator role updated");
...
export const DELETE: APIRoute = withErrorHandler(async ({ params, request }) => {
    ...
    logger.info({ userId: tokenPayload.userId, repoId: repository.id, collaboratorId: userId }, "Collaborator removed");
